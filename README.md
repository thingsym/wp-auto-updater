...
* The auto-updates feature implemented in WordPress core is enabled. (WordPress 5.5 or later) See [Plugin and themes auto-updates](https://wordpress.org/documentation/article/plugins-themes-auto-updates/)
* You have set an update Constant. (AUTOMATIC_UPDATER_DISABLED or WP_AUTO_UPDATE_CORE) See [Update Configuration](https://developer.wordpress.org/advanced-administration/upgrade/upgrading/#update-configuration)
