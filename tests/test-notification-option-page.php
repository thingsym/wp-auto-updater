...
class Test_Wp_Auto_Updater_Notification_Option_Page extends WP_UnitTestCase {
	...
	public function register_settings() {
		...
		$this->assertEquals( 'wp_auto_updater', $wp_registered_settings['wp_auto_updater_notification_options']['group'] );
		...
		$this->assertEquals( 'notification', $wp_settings_sections['wp_auto_updater']['notification']['id'] );
		$this->assertEquals( 'Notification', $wp_settings_sections['wp_auto_updater']['notification']['title'] );
		...
		$this->assertEquals( 'core', $wp_settings_fields['wp_auto_updater']['notification']['core']['id'] );
		$this->assertEquals( 'WordPress Core', $wp_settings_fields['wp_auto_updater']['notification']['core']['title'] );
		...
		$this->assertEquals( 'theme', $wp_settings_fields['wp_auto_updater']['notification']['theme']['id'] );
		$this->assertEquals( 'Theme', $wp_settings_fields['wp_auto_updater']['notification']['theme']['title'] );
		...
		$this->assertEquals( 'plugin', $wp_settings_fields['wp_auto_updater']['notification']['plugin']['id'] );
		$this->assertEquals( 'Plugin', $wp_settings_fields['wp_auto_updater']['notification']['plugin']['title'] );
		...
		$this->assertEquals( 'translation', $wp_settings_fields['wp_auto_updater']['notification']['translation']['id'] );
		$this->assertEquals( 'Translation', $wp_settings_fields['wp_auto_updater']['notification']['translation']['title'] );
		...
		$this->assertEquals( 'from_mail', $wp_settings_fields['wp_auto_updater']['notification']['from_mail']['id'] );
		$this->assertEquals( 'From Email', $wp_settings_fields['wp_auto_updater']['notification']['from_mail']['title'] );
		...
		$this->assertEquals( 'recipients', $wp_settings_fields['wp_auto_updater']['notification']['recipients']['id'] );
		$this->assertEquals( 'Recipients', $wp_settings_fields['wp_auto_updater']['notification']['recipients']['title'] );
	...
	public function capability() {
		$this->assertEquals( 'update_core', $this->wp_auto_updater_notification->option_page_capability() );
	}
